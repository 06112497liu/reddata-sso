 ...
 * 
 * @author byron
 * @version $Id: BdssoVisitHistoryResult.java, v 0.1 Sep 26, 2017 10:15:35 AM byron Exp $
 */
public class BdssoVisitHistoryResult extends BdssoBaseResult {

    /** 序列化id */
    private static final long       serialVersionUID = 7257891780545232683L;

    /** 结果列表 */
    private List<SsoVisitHistoryVO> resultList       = new ArrayList<SsoVisitHistoryVO>();
     ...
     */
    public List<SsoVisitHistoryVO> getResultList() {
        return resultList;
    }
     ...
     */
    public void setResultList(List<SsoVisitHistoryVO> resultList) {
