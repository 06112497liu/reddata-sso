 ...
 * 
 * @author byron
 * @version $Id: SsoUserRoleVO.java, v 0.1 Sep 13, 2017 2:33:33 PM byron Exp $
 */
public class SsoUserRoleVO implements Serializable {

    /** 序列化id */
    private static final long serialVersionUID = 2514745519903604033L;
