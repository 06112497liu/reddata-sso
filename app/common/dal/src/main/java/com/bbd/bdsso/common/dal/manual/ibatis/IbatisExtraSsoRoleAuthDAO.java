...
public class IbatisExtraSsoRoleAuthDAO extends SqlMapClientDaoSupport implements ExtraSsoRoleAuthDAO {
    ...
    public PageList fuzzyQueryForPage(String key, int pageSize, int pageNum) throws DataAccessException {
        ...
        paginator.setItems(((Integer) getSqlMapClientTemplate().queryForObject("MS-BDSSO-Extra-SSO-ROLE-AUTH-FUZZY-QUERY-FOR-PAGE-COUNT-FOR-PAGING", param)).intValue());
        ...
        if (paginator.getBeginIndex() <= paginator.getItems()) {
            ...
            pageList.addAll(getSqlMapClientTemplate().queryForList("MS-Extra-SSO-ROLE-AUTH-FUZZY-QUERY-FOR-PAGE", param));
        }
