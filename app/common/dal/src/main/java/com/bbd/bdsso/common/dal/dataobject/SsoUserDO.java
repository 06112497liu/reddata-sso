...
/**
 * A data object class directly models database table <tt>sso_user</tt>.
 *
 ...
 */
public class SsoUserDO implements Serializable {
	...
	/**
	 * This property corresponds to db column <tt>user_password</tt>.
	 */
