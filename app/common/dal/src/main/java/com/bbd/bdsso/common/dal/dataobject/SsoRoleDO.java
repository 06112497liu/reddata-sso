...
/**
 * A data object class directly models database table <tt>sso_role</tt>.
 *
 ...
 */
public class SsoRoleDO implements Serializable {
	...
	/**
	 * This property corresponds to db column <tt>role_name</tt>.
	 */
