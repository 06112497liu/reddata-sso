...
public class IbatisExtraSsoAppDAO extends SqlMapClientDaoSupport implements ExtraSsoAppDAO {
    ...
    public PageList fuzzyQueryForPage(String key, int pageSize, int pageNum) throws DataAccessException {
        ...
        paginator.setItems(((Integer) getSqlMapClientTemplate().queryForObject("MS-BDSSO-Extra-SSO-APP-FUZZY-QUERY-FOR-PAGE-COUNT-FOR-PAGING", param)).intValue());
        ...
        if (paginator.getBeginIndex() <= paginator.getItems()) {
            ...
            pageList.addAll(getSqlMapClientTemplate().queryForList("MS-Extra-SSO-APP-FUZZY-QUERY-FOR-PAGE", param));
        }
