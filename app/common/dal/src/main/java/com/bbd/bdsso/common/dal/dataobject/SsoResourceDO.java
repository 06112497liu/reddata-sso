...
/**
 * A data object class directly models database table <tt>sso_resource</tt>.
 *
 ...
 */
public class SsoResourceDO implements Serializable {
	...
	/**
	 * This property corresponds to db column <tt>resource_name</tt>.
	 */
